...
public static class PathUtils
{
	...
	{
		Vector3 frontVector = GetPointOnBezierCurve(a, b, c, Mathf.Clamp01(t + 0.05f));
		Vector3 rearVector = GetPointOnBezierCurve(a, b, c, Mathf.Clamp01(t - 0.05f));
	...
	public struct BezierCurve3
	{
		...
		public float Length()
		{
			...
			for (int i = 0; i < curve.Length - 1; i++)
				sum += Vector3.Distance(curve[i], curve[i + 1]);
